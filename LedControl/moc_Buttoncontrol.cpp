...
QT_MOC_LITERAL(1, 14, 8), // "buttonOn"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 9), // "buttonOff"
QT_MOC_LITERAL(4, 34, 11) // "checkButton"

    },
    "Buttoncontrol\0buttonOn\0\0buttonOff\0"
    "checkButton"
};
...
void Buttoncontrol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->buttonOn(); break;
        case 1: _t->buttonOff(); break;
        case 2: _t->checkButton(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Buttoncontrol::buttonOn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Buttoncontrol::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Buttoncontrol::buttonOff)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Buttoncontrol::buttonOn()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Buttoncontrol::buttonOff()
{
